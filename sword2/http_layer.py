...
class HttpLib2Layer(HttpLayer):
    def __init__(self, cache_dir, timeout=30, ca_certs=None, disable_ssl_certificate_validation=False):
        self.h = httplib2.Http(".cache", timeout=30.0, ca_certs=ca_certs, disable_ssl_certificate_validation=disable_ssl_certificate_validation)
